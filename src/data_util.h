...
typedef string ImageName;	// image name
typedef string ImagePath;   // The whole image path
...
typedef int PointId;  // Data type for point identifier
/**
* \typedef
...
// Given a imgpath, return the img name
